...
// Usamos computed para obtener el usuario de forma segura
                    ...
                    <div class="flex justify-between h-16">
                        ...
                        <div class="hidden sm:flex sm:items-center sm:ms-6">
                            ...
                            <div class="relative ms-3">
                                <!-- SOLO MOSTRAMOS EL DROPDOWN SI HAY USUARIO -->
                                ...
                                <!-- SI NO HAY USUARIO (GUEST), MOSTRAMOS LOGIN -->
                                <div v-else class="flex gap-4">
                                     <Link :href="route('login')" class="text-sm text-gray-700 dark:text-gray-300 hover:text-indigo-500">Log in</Link>
                                </div>
                            </div>
                        </div>
                                ...
                                <svg class="w-6 h-6" stroke="currentColor" fill="none" viewBox="0 0 24 24">
                                    <path
                                        :class="{
                                            ...
                                            inline: !showingNavigationDropdown,
                                        }"
